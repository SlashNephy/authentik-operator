...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name authentik-operator-builder
	$(CONTAINER_TOOL) buildx use authentik-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm authentik-operator-builder
	rm Dockerfile.cross
...
## Tool Binaries
## The tools are installed and pinned by mise (see mise.toml).
KUBECTL ?= kubectl
KIND ?= kind
KUSTOMIZE ?= kustomize
...
authentik-down: ## Delete the kind cluster started by authentik-up.
